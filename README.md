...
* **UI Components**: `Modal`, `ToastContainer`, `Pagination`, `Skeleton`, `ConfirmModal`, `LinkifiedText`.
...
*Note: You may need to install peer dependencies (`react`, `react-dom`, `zustand`, `lucide-react`) depending on the modules you use.*
