...
- ../BigStone/.claude/research/summary.md 와 ../zlod/.claude/research/summary.md 를 참고로 2 프로젝트를 충분히 검토하고 이해한다.
- 가능한 두 프로젝트에서 공통으로 사용되는 로직은 따로 zCommon 프로젝트에 구현한다.
- zCommon 프로젝트는 BigStone 과 zlod 두 프로젝트에서 공통으로 사용된다.
- zCommon 프로젝트의 라이브러리가 수정될경우 충분히 2프로젝트에서 사이드 이펙트가 발생하지 않는지 검토한다.
