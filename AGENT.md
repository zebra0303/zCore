...
- ../BigStone/.claude/research/summary.md, ../zlog/.claude/research/summary.md, ../zGo/.claude/research/summary.md 를 참고로 3 프로젝트를 충분히 검토하고 이해한다.
- 가능한 세 프로젝트에서 공통으로 사용되는 로직은 따로 zCore 프로젝트에 구현한다.
- zCore 프로젝트는 BigStone, zlog, zGo 세 프로젝트에서 공통으로 사용된다.
- zCore 프로젝트의 라이브러리가 수정될경우 충분히 2프로젝트에서 사이드 이펙트가 발생하지 않는지 검토한다.
- 각 프로젝트의 .claude/research 폴더 밑의 md파일들을 읽어서 프로젝트 전반적인 내용을 숙지하고 있어야 합니다.
